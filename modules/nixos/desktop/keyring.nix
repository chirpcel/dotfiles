    ...
    { lib, pkgs, ... }:
    {
      ...
      security.pam.services.greetd.rules = {
        ...
        auth.oo7 = {
          order = 12000;
          control = "optional";
          modulePath = "${self.packages.${pkgs.system}.oo7-full}/lib/security/pam_oo7.so";
        };
        auth.permit = {
          order = 12400;
          control = "sufficient";
      ...
      systemd.user.services = {
        "oo7-daemon" = {
          ...
          serviceConfig = {
            Type = "simple";
            ExecStart = "${self.packages.${pkgs.system}.oo7-full}/bin/oo7-daemon --login";
            Restart = "on-failure";
            RestartSec = 2;
        ...
        "oo7-portal" = {
          ...
          serviceConfig = {
            ...
            ExecStart = "${self.packages.${pkgs.system}.oo7-full}/bin/oo7-portal";
            Restart = "on-failure";
            RestartSec = 2;
          };
        };
